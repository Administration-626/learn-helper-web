...
export function CopyIcon({ size = 14, className, style }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
...
export function PinIcon({ size = 14, className, style }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
...
export function DownloadIcon({ size = 14, className, style }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
...
export function StopIcon({ size = 12, className, style }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
...
export function SendIcon({ size = 14, className, style }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
...
export function LightbulbIcon({ size = 16, className, style }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
...
export function ChartBarIcon({ size = 16, className, style }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
